...
|----------|-------|-------|----------|--------|
| [IMPL-0.5.md](./IMPL-0.5.md) | Phase 0.5: Game Setup Flow & UI Foundation | Scenario/faction selection overhaul, pre-game settings, officer portraits, city illustrations | Critical | Not started |
