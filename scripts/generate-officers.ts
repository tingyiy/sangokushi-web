...
// Load RTK4 data
const rtk4 = JSON.parse(fs.readFileSync(rtk4Path, 'utf-8')) as Array<any>;

// Old officers to extract skills mapping
...
// Mapping old->new IDs for 82 old officers
const idMap: Record<number, number> = {
  1:169,2:100,3:390,4:443,5:421,6:204,7:128,8:308,9:229,10:70,11:143,12:96,13:388,14:98,
  20:11,21:326,22:334,23:398,24:339,25:391,26:347,27:55,28:350,29:349,30:103,31:136,32:253,
  33:18,34:17,35:372,36:384,50:264,51:258,52:273,53:430,54:199,55:194,56:82,57:281,58:125,
  59:196,60:415,61:44,62:108,70:187,71:66,72:376,73:377,74:170,75:185,76:208,77:94,78:285,
  79:399,80:219,85:123,86:354,87:309,88:160,89:396,91:158,92:104,93:288,94:147,95:244,96:75,
  97:84,98:133,99:410,101:6,102:151,103:152,104:310,106:353,107:223,108:222,109:32,110:228,
  111:205,112:343,113:402,114:355
};
...
// Build entries
const entries: string[] = rtk4.map(o => {
  const id = o.id;
  const nameZh = id===19 ? '曹叡' : o.name_zh;
  const skills = Object.values(idMap).includes(id) ? skillMap[Object.keys(idMap).find(k=>idMap[+k]===id)!] || [] : [];
...
custom.forEach(c => {
  entries.push(`  { id: ${c.id}, name: '${c.name}', portraitId: ${c.id}, birthYear: ${c.birthYear}, deathYear: ${c.deathYear}, leadership: ${c.leadership}, war: ${c.war}, intelligence: ${c.intelligence}, politics: ${c.politics}, charisma: ${c.charisma}, skills: [${c.skills.map(s=>`'${s}'`).join(', ')}] }`);
});
...
console.log('Generated officers.ts with', entries.length, 'entries');
