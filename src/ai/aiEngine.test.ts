...
describe('AI Engine', () => {
  const mockState: GameState = {
    ...
    officers: [
      { id: 1, name: 'Player Ruler', factionId: 1, cityId: 1, stamina: 100, loyalty: 100, leadership: 80, war: 80, intelligence: 80, politics: 80, charisma: 80, skills: [], portraitId: 1, birthYear: 160, deathYear: 230, isGovernor: true, treasureId: null },
      { id: 2, name: 'AI Ruler', factionId: 2, cityId: 2, stamina: 100, loyalty: 100, leadership: 80, war: 80, intelligence: 80, politics: 80, charisma: 80, skills: ['製造'], portraitId: 2, birthYear: 160, deathYear: 230, isGovernor: true, treasureId: null },
    ],
    year: 190,
    month: 1,
    phase: 'playing',
  ...
  it('should prioritize personnel actions', () => {
    const stateWithFreeOfficer = {
      ...
      officers: [
        ...mockState.officers,
        { id: 3, name: 'Free Agent', factionId: null, cityId: 2, stamina: 100, loyalty: 0, leadership: 50, war: 50, intelligence: 50, politics: 50, charisma: 50, skills: [], portraitId: 3, birthYear: 160, deathYear: 230, isGovernor: false, treasureId: null }
      ]
    };
  ...
  it('should generate offensive decisions when troop advantage is high', () => {
    const offensiveState = {
      ...
      officers: [
          ...mockState.officers,
          { id: 4, name: 'General', factionId: 2, cityId: 2, stamina: 100, loyalty: 100, leadership: 80, war: 80, intelligence: 80, politics: 80, charisma: 80, skills: [], portraitId: 4, birthYear: 160, deathYear: 230, isGovernor: false, treasureId: null }
      ]
    };
